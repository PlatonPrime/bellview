...
$coupon_code_id="";
$Rid=$_SESSION['RID'];
$coupon_code_id =$_GET['coupon_code_id'];
    //session_destroy(); 
if($Rid=="")
{
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                              <ul id="myTab3" class="tab-review-design">
                                <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i> Edit Coupon code</a></li>

                              </ul>

                              <?php 
                              require_once "../database/config.php";
                              $query= "SELECT * FROM coupon_code where Rest_id='$Rid' and coupon_code_id='$coupon_code_id'";
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-lg-8 col-sm-8 col-sm-8 col-xs-12">
                                      ...
                                      <div class="review-content-section"> 
                                        <form method="post" action="php/updateCouponCode.php">
                                          <div class="input-group mg-b-pro-edt">
                                            <input type="hidden" name="coupon_code_id" value="<?php echo $coupon_code_id; ?>">
                                          <input type="text" class="form-control" placeholder="Coupon Code" name="couponcode" id="couponcode" value="<?php echo $couponcode; ?>" minlength="6" maxlength="14" style="text-transform: uppercase;" required>
                                        </div>
                                        <div class="input-group mg-b-pro-edt">
                                        ...
                                        <div class="input-group mg-b-pro-edt">
                                          <input type="text" class="form-control" placeholder="Expire Date" name="expire_date" id="expire_date" autocomplete="off" value="<?php echo $expire_date; ?>" required >
                                        </div>
                                        <div class="input-group mg-b-pro-edt">
                                          <input type="number" class="form-control" placeholder="Usage Limit" name="usage_limit" id="usage_limit" autocomplete="off" value="<?php echo $usage_limit; ?>" required >
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                          <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                            ...
                                            <a href="manageCouponCode.php" class="btn btn-warning waves-effect waves-light">Back
                                            </a>
                                          </div>
                                        </div>
                                      </form>
