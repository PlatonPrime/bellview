...
<head>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0">
    ...
    <!-- Title Page-->
    <title>BellView | Product Description</title>
...
<body class="animsition">
  ...
  -moz-box-shadow: 0 1px 5px rgba(0, 0, 0, 0.2);
                ...
                <div class="account2">
                    ...
                    <a href="php/admin_logout.php">Sign out</a>
                </div>
...
function show() {
  ...
  button.onclick = function() { hide(); };
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                ...
                                <?php 
                require_once "../database/config.php";
                $sqlimage= "SELECT *  FROM restauantproduct where 	Rest_id='$Rid' and RPID='$PID'";
                $imageresult1 = mysqli_query($conn, $sqlimage);
                while($rows=mysqli_fetch_assoc($imageresult1))
                {
                    $image = $rows['RPImage'];
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="avatar-upload">
                                                    ...
                                                    <div class="avatar-preview">
                                                        <div id="imagePreview" style="background-image:     url(<?php echo "../upload/item_image/".$image; ?>);">
                                                        </div>
                                                    </div>
                                                </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-xs12">
                                                ...
                                                <div class="review-content-section"> 
                                                    ...
                                                    <form method="post" action="php/productDetails.php">
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" name="product_desc" id="product_desc" value="" placeholder="Enter the description"/>
                                                    </div>
                                                    
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" name="product_ben" id="product_ben" placeholder="Enter the benifits" >
                                                    </div>
                                                    
                                                        
                                                        <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" name="product_pro" id="product_pro" placeholder="Enter the protein between 6 to 8.3%" >
                                                    </div>
                                                        ...
                                                        <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" name="product_car" id="product_car" placeholder="Enter the carbohydrates between 45 to 65%" >
                                                    </div>
                                                    
                                                        
                                                        <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" name="product_fac" id="product_fac" placeholder="Enter the facts between 5% to 20%" >
                                                    </div>
                                                    
                                                        
                                                        <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" name="product_lip" id="product_lip" placeholder="Enter the lipid  below 200 mg/dL" >
                                                    </div>
                                                    
                                                        
                                                        <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" name="product_iod" id="product_iod" placeholder="Enter the iodine range between 70% - 80%" >
                                                    </div>
                                                ...
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                    ...
                                                    $_SESSION['PIDPU']=$PID;?>
                                                    <input type="submit" onclick="return val()" class="btn btn-primary waves-effect waves-light m-r-10" name="insert" value="Submit"/>
														
                                                    <a href="index.php" class="btn btn-warning waves-effect waves-light">Back
														</a>
                                                </div>
                                            </div>
                                                    </form>
    ...
    <script  type="text/javascript">   
        function val(){
            var resname=document.getElementById("product_desc").value;
                if( resname!= "")
                {
                    var resname2=document.getElementById("product_ben").value;
                    if( resname2!= "")
                    {
                        var resname3=document.getElementById("product_pro").value;
                        if( resname3!= "")
                        {
                            var resname4=document.getElementById("product_car").value;
                            if( resname4!= "")
                            {
                                var resname5=document.getElementById("product_fac").value;
                                if( resname5!= "")
                                {
                                    var resname6=document.getElementById("product_lip").value;
                                    if( resname6!= "")
                                    {
                                        var resname7=document.getElementById("product_iod").value;
                                        if( resname7!= "")
                                        {
                                            return true;     
                                        }
                                        else{
                                            alert("Enter the iodine");
                                            return false;    
                                        }     
                                    }
                                    else{
                                        alert("Enter the lipid");
                                        return false;    
                                    }  
                                }
                                else{
                                    alert("Enter the facts");
                                    return false;    
                                }   
                            }
                            else{
                                alert("Enter the carbohydrates");
                                return false;    
                            } 
                        }
                        else{
                            alert("Enter the protein");
                            return false;    
                        }
                    }
                    else{
                        alert("Enter the benifits");
                        return false;
                    }
                }
                else{
