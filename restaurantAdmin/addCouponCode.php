                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div class="review-tab-pro-inner">
                            <ul id="myTab3" class="tab-review-design">
                              <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i> Add Coupon code</a></li>
                            </ul>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-8 col-sm-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="review-content-section"> 
                                      <form id="couponCodeForm" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12"></div>
                                          <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" id="descriptionid">
                                            <div class="review-content-section">
                                              <div class="input-group mg-b-pro-edt">
                                                <input type="text" class="form-control" placeholder="Coupon Code" name="couponcode" id="couponcode" style="text-transform: uppercase;" minlength="6" maxlength="14" required>
                                              </div>
                                              <div class="input-group mg-b-pro-edt">
                                              ...
                                              <div class="input-group mg-b-pro-edt">
                                                <input type="text" class="form-control" placeholder="Expire Date" name="expire_date" id="expire_date" autocomplete="off" required >
                                              </div>
                                              <div class="input-group mg-b-pro-edt">
                                                <input type="number" class="form-control" placeholder="Usage Limit" name="usage_limit" id="usage_limit" autocomplete="off" required >
                                              </div>
                                              ...
                                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                  ...
                                                  <button type="submit" name="action"  class="btn btn-primary waves-effect waves-light m-r-10 dell">Save
                                                  </button>
        ...
        $.ajax({
          ...
          success:function(data)
          {
            if(data=="1")
            {
              ...
              window.location.href="manageCouponCode.php";
            } else {
              alert(data);
            }
          }
