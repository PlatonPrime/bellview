...
<head>
    ...
    <!-- Title Page-->
    <title>BellView | New Offer</title>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i> Offer Edit</a></li>
                                    
                                </ul>
                                
                                
                                
                                <div id="myTabContent" class="tab-content custom-product-edit" style="margin-top:-35px">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-top:-20px;">
                                                ...
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Product Name" name="offer_item_name" id="offer_item_name" maxlength=20 >
                                                    </div>
                                                    
                                                    
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="Enter the Decription" name="offer_item_desc" id="offer_item_desc" maxlength=20 >
                                                    </div>
                                                    
                                                    
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="Total Cost" name="offer_item_cost" id="offer_item_cost" maxlength=4 onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                                    </div>
                                                    
                                                    
                                                    <div class="input-group mg-b-pro-edt">
                                                    <select  class="form-control" name="offer_item_vn" id="offer_item_vn">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                    <select  class="form-control" name="offer_item_st" id="offer_item_st">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="GST" name="offer_item_gst" id="offer_item_gst" maxlength=2 onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                                    </div>
                                                ...
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                    ...
                                                    <button type="submit" name="newoffer" id="newoffer"  class="btn btn-primary waves-effect waves-light m-r-10">Save
														</button>
    ...
    $(document).ready(function()
    {
        $('#image_form').submit(function(event)
        {
            ...
            else
            {
                ...
                {
                    var resitname=document.getElementById("offer_item_name").value;
                    if(resitname!= "")
                    {
                        var resitdesc=document.getElementById("offer_item_desc").value;
                        if(resitdesc!= "")
                        {
                            var resitcost=document.getElementById("offer_item_cost").value;
                            if( resitcost!= "")
                            {
                                var mydropdown1 = $('#offer_item_vn');
                                if (!(mydropdown1.length == 0 || $(mydropdown1).val() == ""))
                                {
                                    var mydropdown = $('#offer_item_st');
                                    if (!(mydropdown.length == 0 || $(mydropdown).val() == ""))
                                    {
                                      var resitgst=document.getElementById("offer_item_gst").value;
                                      if( resitgst!= "")
                                      {
                                        $.ajax({
                                            url:"php/addItemOffer.php",
                                            method:"post",
                                            ...
                                            success:function(data)
                                            {
                                                if(data=="1")
                                                {
                                                    ...
                                                    //         $('#image_form')[0].reset();
                                                    window.location.href="  manageOffer.php";
