...
<head>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0">
    ...
    <!-- Title Page-->
    <title>BellView | Product Update</title>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-xs12">
                                                ...
                                                <div class="review-content-section"> 
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="<?php echo $rSN;  ?>" disabled>
                                                    </div>
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" name="res_gst" id="res_gst" value="<?php echo $rGST;?>" placeholder="Enter the GST" maxlength=2 onkeypress="return event.charCode >= 48 && event.charCode <= 57"/>
                                                    </div>
