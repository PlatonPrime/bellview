                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div class="review-tab-pro-inner">
                            <ul id="myTab3" class="tab-review-design">
                              <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i> Add Product Addon</a></li>
                            </ul>
                                            ...
                                            <div class="review-content-section">
                                              <div class="input-group mg-b-pro-edt">
                                                ...
                                                <select  class="form-control" name="product_id" id="product_id" required>
                                                  ...
                                                  $sqlimage= "SELECT *  FROM restauantproduct where Rest_id='$Rid'";
                                                    ...
                                                    while($rows=mysqli_fetch_assoc($imageresult1)) {
                                                  ?>
                                                  <option value="<?php echo $rows['RPID']; ?>"><?php echo $rows['RPName']; ?></option>    
                                                  <?php } ?>
                                                </select>
                                              </div>
                                              <div class="input-group mg-b-pro-edt">
                                                <input type="text" class="form-control" placeholder="Addon" name="addon" id="addon" required >
                                              </div>
                                              <div class="input-group mg-b-pro-edt">
                                                <input type="number" class="form-control" placeholder="Price" name="price" id="price" autocomplete="off" required >
                                              </div>
                                              ...
                                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                  ...
                                                  <a href="productAddon.php" class="btn btn-warning waves-effect waves-light">Back
                                                  </a>
                                                </div>
                                              </div>
                                            </div>
        ...
        $.ajax({
          ...
          success:function(data)
          {
            if(data=="1")
            {
              ...
              window.location.href="productAddon.php";
            } else {
              alert(data);
            }
          }
