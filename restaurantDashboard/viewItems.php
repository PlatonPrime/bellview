...
<head>
    ...
    <!-- Title Page-->
    <title>BellView | View Item</title>
...
function showUser(str) {
  ...
  xmlhttp.open("GET","getItem.php?q="+str+"&qq=<?php echo $Rid; ?>",true);
  xmlhttp.send();
}
</script>
    <style>
...
>
                                        ...
                                        <button  type="button" class="au-btn-filter" onclick="$('#hi').hide(); showUser(users.value);">
                                    ...
                                    <div class="table-data__tool-right" id="filet">
                                        ...
                                        <a href="addItem.php" class="au-btn au-btn-icon au-btn--green au-btn--small" style="margin-right:5px;">
                                            <i class="zmdi zmdi-plus"></i>add item</a>
                                        <a href="manageOffer.php" style="margin-left:5px;" class="au-btn au-btn-icon au-btn--green au-btn--small">Manage Offer</a>
                                        ...
                                        <tbody  >
                                            ...
                                            <tr >
                                                ...
                                                <td> <div class="table-data-feature">
                                                    <a href='editItem.php?Pid=<?php echo $RPID[$j]; ?>' role="button" class="item" data-placement="top" title="Edit">
