  ...
  -moz-box-shadow: 0 1px 5px rgba(0, 0, 0, 0.2);
            ...
            <?php 
                ...
                while($rows=mysqli_fetch_assoc($imageresult1))
                {
                    ...
                    $rn=$rows['Rest_name'];
                    $ra=$rows['Rest_addr'] ;
                    $rp=$rows['Rest_pincode'] ;
                    $rc=$rows['Rest_contact'] ;
                    $re= $rows['Rest_email'];
                    $rt= $rows['Rest_tables'];
                }
                ?>  
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" id="accoutny">
                                                ...
                                                <div class="avatar-upload">
                                                    ...
                                                    <div class="avatar-preview">
                                                        <div id="imagePreview" style="background-image:     url(<?php echo "../upload/restaurant_image/".$image; ?>);">
                                                        </div>
                                                    </div>
                                                </div>    
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" id="acountyu">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="<?php echo $re;  ?>" disabled>
                                                    </div>
                                                    
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="<?php echo $rt;  ?>" disabled>
                                                    </div>
